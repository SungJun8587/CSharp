...
namespace JwtAuthCommon.Repositories
{
    ...
    public class RefreshTokenRepository : IRefreshTokenRepository
    {
        ...
        /// <returns>비동기 작업</returns>
        public async Task InvalidateAsync(RefreshTokenEntity token, string? replacedByToken = null)
        {
            // 1. 토큰 폐기 시간 기록
        ...
        public async Task<IEnumerable<RefreshTokenEntity>> GetAllValidTokensForUserAsync(long userId)
        {
        ...
        public async Task<IEnumerable<RefreshTokenEntity>> GetActiveTokensForUserDeviceAsync(long userId, string deviceId)
        {
            return await _db.RefreshTokens
