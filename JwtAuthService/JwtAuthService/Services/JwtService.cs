    ...
    public class JwtService : IJwtService
    {
        ...
        public string GenerateAccessToken(User user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim("username", user.Username ?? string.Empty),                       // 사용자 이름 추가
        ...
        public async Task<(string accessToken, string refreshToken)> GenerateTokensAsync(User user, string? deviceId = null)
        {
